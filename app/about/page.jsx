...
const About = () => (
  <section className="w-full flex flex-col items-center p-10 bg-gray-50">
    <div className="max-w-4xl w-full">
      <h1 className="head_text text-center mb-8 text-5xl font-extrabold bg-gradient-to-r from-indigo-500 to-purple-500 bg-clip-text text-transparent">
        About Me
      </h1>
      <article className="max-w-3xl mx-auto text-lg leading-relaxed text-gray-700 p-6 bg-white rounded-xl shadow-lg">
        <h2 className="text-xl font-bold mb-4">My Background and My Recent Work</h2>
        <p className="mb-4">
          At this point, there is no sole reason why I make art. I do it for the enjoyment of doing it. However, for many years, one of my quests has been to enhance my own awareness of who I am as a human being. My experience is that I have used creating art to heighten this awareness.
        </p>
        <p className="mb-4">
